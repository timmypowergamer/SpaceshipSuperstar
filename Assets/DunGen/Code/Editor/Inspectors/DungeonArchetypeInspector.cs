...
namespace DunGen.Editor
{
	...
	public sealed class DungeonArchetypeInspector : UnityEditor.Editor
	{
        public override void OnInspectorGUI()
        {
			...
			EditorGUILayout.BeginVertical("box");
			EditorGUILayout.HelpBox("The percentage chance that an unconnected but overlapping set of doorways within this archetype will be connected", MessageType.Info);
			archetype.DoorwayConnectionChance = EditorGUILayout.Slider("Connection Chance", archetype.DoorwayConnectionChance, 0, 1);
			EditorGUILayout.EndVertical();
