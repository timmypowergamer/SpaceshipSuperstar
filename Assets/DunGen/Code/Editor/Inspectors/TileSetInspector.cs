...
namespace DunGen.Editor
{
	...
	public sealed class TileSetInspector : UnityEditor.Editor
	{
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorUtil.DrawGameObjectChangeTableGUI("Tile", tileSet.TileWeights, tileShowWeights);
			...
			if(showLockPrefabs)
			{
				...
				for (int i = 0; i < tileSet.LockPrefabs.Count; i++)
				{
					...
					EditorUtil.DrawGameObjectChangeTableGUI("Prefab", l.LockPrefabs, lockPrefabShowWeights[i]);
